...
output: 
  html_document: 
    self_contained: no
categories: [projects]
tags: [data cleaning, tidy datasets, r, UCI, HAR, sensor data, dpyr]
---
### Summary
...
There are two types on sensors used in this experiement, accelerometer and gyroscope. Each produce 3-dimensional raw signals, tAcc-XYZ and tGyro-XYZ. Body and gravity acceleration signals are extracted from the raw signals. Then body linear acceleration and angular velocity were derived in time. Also the magnitude of these three-dimensional signals were calculated. 
